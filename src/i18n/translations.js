const en = {
  ...
  about: {
    ...
    cards: [
      { title: 'Immersive Coastal Access', desc: "Positioned within 50 metres of Watamu's pristine white-sand beaches — the ocean is not a backdrop, it is part of your daily life here." },
      { title: 'Artisan Craftsmanship', desc: 'Every suite is shaped by Swahili-inspired design — hand-carved details, organic textures and purposefully chosen furnishings that honour the coast.' },
      { title: 'Elevated Comfort', desc: 'Rooftop infinity pool, ground-floor leisure pool, fully equipped kitchens, high-speed Wi-Fi and 24/7 concierge — comfort as a standard, not an upgrade.' },
      { title: 'Living With Nature', desc: "Wake up to panoramic vistas of the Indian Ocean and Watamu's lush coastline from your private balcony or terrace. Nature frames every moment." },
      { title: 'Trust & Peace of Mind', desc: '24-hour on-site security, CCTV surveillance, night guards and secure private parking — so you can rest, explore and return with complete confidence.' },
      { title: 'Responsible Luxury', desc: 'We believe luxury should leave a lighter footprint. Eco-conscious practices, local sourcing and community support are woven into how we host.' },
      { title: 'Graceful Ease', desc: 'Flexible arrivals, dedicated housekeeping, concierge-arranged excursions and airport transfers — every logistic handled so your stay flows effortlessly.' },
    ],
  },
  gallery: {
...
const it = {
  ...
  about: {
    ...
    cta: 'Scopri di Più',
    cards: [
      { title: 'Accesso Costiero Immersivo', desc: 'A soli 50 metri dalle candide spiagge di Watamu — l\'oceano non è uno sfondo, è parte della tua vita quotidiana qui.' },
      { title: 'Artigianato Artistico', desc: 'Ogni suite è plasmata dal design swahili — dettagli scolpiti a mano, texture organiche e arredi scelti con cura che onorano la costa.' },
      { title: 'Comfort Elevato', desc: 'Piscina infinity sul rooftop, piscina leisure al piano terra, cucine complete, Wi-Fi ad alta velocità e servizio di concierge 24/7.' },
      { title: 'Vivere con la Natura', desc: 'Svegliatevi con viste panoramiche sull\'Oceano Indiano e sulla costa di Watamu dal vostro balcone privato. La natura incornicia ogni momento.' },
      { title: 'Fiducia e Tranquillità', desc: 'Sicurezza 24 ore su 24, videosorveglianza, guardie notturne e parcheggio privato sicuro — per riposare ed esplorare con piena fiducia.' },
      { title: 'Lusso Responsabile', desc: 'Crediamo che il lusso debba lasciare un\'impronta più leggera. Pratiche eco-consapevoli, approvvigionamento locale e supporto alla comunità sono parte del nostro modo di ospitare.' },
      { title: 'Semplicità Elegante', desc: 'Arrivi flessibili, pulizie dedicate, escursioni organizzate dal concierge e trasferimenti aeroportuali — ogni logistica curata perché il tuo soggiorno scorra senza sforzo.' },
    ],
  },
  gallery: {
