...
import aboutImg from '../assets/suite-chiara-hero-page-section-image.jpeg'
import sofiaPreviewImg from '../assets/penthouse-suite-view-from-outside.jpg'
import luciaPreviewImg from '../assets/suite-lucia-homepage-card-preview-image.jpeg'

import g1  from '../assets/suite-chiara-1stbedroom-view1.jpeg'
import g2  from '../assets/suite-chiara-1stbedroom-view2.jpeg'
import g3  from '../assets/suite-chiara-1stbedroom-view3.jpeg'
import g4  from '../assets/suite-chiara-2ndbedroom-view1.jpeg'
import g5  from '../assets/suite-chiara-2ndbedroom-view2.jpeg'
import g6  from '../assets/suite-chiara-2ndbedroom-view3.jpeg'
import g7  from '../assets/suite-chiara-2ndbedroom-view4.jpeg'
import g8  from '../assets/suite-chiara-3rdbedroom-view1.jpeg'
import g9  from '../assets/suite-chiara-3rdbedroom-view2.jpeg'
import g10 from '../assets/suite-chiara-3rdbedroom-view3.jpeg'
import g11 from '../assets/suite-chiara-3rdbedroom-view4.jpeg'
import g12 from '../assets/suite-chiara-bathroom-view1.jpeg'
import g13 from '../assets/suite-chiara-2nd-washroom-view.jpeg'
import g14 from '../assets/suite-chiara-3rd-shower-view.jpeg'
import g15 from '../assets/suite-chiara-3rd-washroom-view.jpeg'
import g16 from '../assets/suite-chiara-3rdwashroom-main-view.jpeg'
import g17 from '../assets/suite-chiara-main-washroom-view.jpeg'
import g18 from '../assets/suite-chiara-full-kitchen-view-cinematic.jpeg'
import g19 from '../assets/suite-chiara-kitchen-view-with-lights.jpeg'
import g20 from '../assets/suite-chiara-kitchen-fullview1.jpeg'
import g21 from '../assets/suite-chiara-kitchen-art-decor-fridge-view1.jpeg'
import g22 from '../assets/suite-chiara-washroom-washing-machine-view.jpeg'
import g23 from '../assets/suite-chiara-dining-table-view1.jpeg'
import g24 from '../assets/suite-chiara-dining-table-view-with-fruits.jpeg'
import g25 from '../assets/suite-chiara-dinining-living-lounge-room-view.jpeg'
import g26 from '../assets/suite-chiara-indoor-lounging-area.jpeg'
import g27 from '../assets/suite-chiara-indoo-lounge-sofa-upclose.jpeg'
import g28 from '../assets/suite-chiara-indoor-lounge-wooden-chairs.jpeg'
import g29 from '../assets/suite-chiara-tv-and-entrance-view.jpeg'
import g30 from '../assets/suite-chiara-entrance-door-close-up.jpeg'
import g31 from '../assets/suite-chiara-entrance-door-from-inside.jpeg'
import g32 from '../assets/suite-chiara-balcony-view.jpeg'
import g33 from '../assets/suite-chiara-balcony-view2.jpeg'
import g34 from '../assets/suite-chiara-outside-terrace-lounge-chairs-with-view.jpeg'
import g35 from '../assets/suite-chiara.jpeg'

const GALLERY = [
  g1,g2,g3,g4,g5,g6,g7,g8,g9,g10,g11,g12,g13,g14,g15,g16,g17,g18,g19,g20,g21,
  g22,g23,g24,g25,g26,g27,g28,g29,g30,g31,g32,g33,g34,g35,
]
const DEFAULT_IMAGE_WIDTH = 352
const GALLERY_LABELS = [
  'Suite Chiara first bedroom view 1',
  'Suite Chiara first bedroom view 2',
  'Suite Chiara first bedroom view 3',
  'Suite Chiara 2nd bedroom view 1',
  'Suite Chiara 2nd bedroom view 2',
  'Suite Chiara 2nd bedroom view 3',
  'Suite Chiara 2nd bedroom view 4',
  'Suite Chiara 3rd bedroom view 1',
  'Suite Chiara 3rd bedroom view 2',
  'Suite Chiara 3rd bedroom view 3',
  'Suite Chiara 3rd bedroom view 4',
  'Suite Chiara bathroom view',
  'Suite Chiara 2nd washroom view',
  'Suite Chiara 3rd shower view',
  'Suite Chiara 3rd washroom view',
  'Suite Chiara 3rd washroom main view',
  'Suite Chiara main washroom view',
  'Suite Chiara full kitchen cinematic view',
  'Suite Chiara kitchen view with lights',
  'Suite Chiara kitchen full view',
  'Suite Chiara kitchen art decor fridge view',
  'Suite Chiara washroom washing machine view',
  'Suite Chiara dining table view',
  'Suite Chiara dining table with fruits',
  'Suite Chiara dining living lounge room view',
  'Suite Chiara indoor lounging area',
  'Suite Chiara indoor lounge sofa up close',
  'Suite Chiara indoor lounge wooden chairs',
  'Suite Chiara TV and entrance view',
  'Suite Chiara entrance door close up',
  'Suite Chiara entrance door from inside',
  'Suite Chiara balcony view',
  'Suite Chiara balcony view 2',
  'Suite Chiara outside terrace lounge chairs with view',
  'Suite Chiara exterior view',
]

const AMENITY_ICONS = [
  BedDouble,       // Beds
  Bath,            // En-suites
  Building2,       // Floors / Layout
  Star,            // Master Bedroom
  UtensilsCrossed, // Fully Equipped Kitchen
  Sofa,            // Lounge
  DoorOpen,        // Balcony / Terrace
  Utensils,        // Indoor Dining Table
  ForkKnife,       // Outdoor Dining
...
export default function SuiteChiaraPage() {
  ...
  return (
    <>
      ...
      <main id="penthouse-suite-chiara-page">

        {/* ── a) Hero ── */}
        <section className="ph-hero">
          <img src={heroImg} alt="Suite Chiara hero view" className="ph-hero__bg" />
            ...
            <div className="ph-about__inner">
              ...
              <motion.div className="ph-about__img-col" {...fadeUp(0.16)}>
                <div className="ph-about__img-wrap">
                  <img src={aboutImg} alt="Suite Chiara interior view" className="ph-about__img" />
            ...
            <motion.div className="ph-about__highlights-row" {...fadeUp(0.2)}>
              <div className="ph-about__image-card">
                <div className="ph-about__highlights-img-wrap">
                  <img
                    src={g34}
                    alt="Suite Chiara outside terrace lounge chairs with view"
        ...
        <section className="ph-suites section" id="explore-suites">
          <div className="container">
            ...
            <div className="ph-suites__grid">
              <motion.div className="ph-suite-card" {...fadeUp(0.22)} onClick={() => navigate('/suites/penthouse-suite-1-sofia')} role="button" tabIndex={0} onKeyDown={e => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); navigate('/suites/penthouse-suite-1-sofia') } }}>
                <div className="ph-suite-card__img-wrap">
                  <img src={sofiaPreviewImg} alt={ts_sofia.heroTitle} className="ph-suite-card__img" loading="eager" />
                </div>
                <div className="ph-suite-card__body">
                  <p className="ph-suite-card__tagline">{pt.sofiaTagline}</p>
                  <h3 className="ph-suite-card__name">{ts_sofia.heroTitle}</h3>
              ...
              <motion.div className="ph-suite-card" {...fadeUp(0.32)} onClick={() => navigate('/suites/suite-lucia')} role="button" tabIndex={0} onKeyDown={e => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); navigate('/suites/suite-lucia') } }}>
                <div className="ph-suite-card__img-wrap">
                  <img src={luciaPreviewImg} alt={tl.heroTitle} className="ph-suite-card__img" loading="eager" />
                </div>
                <div className="ph-suite-card__body">
                  <p className="ph-suite-card__tagline">{pt.luciaTagline}</p>
                  <h3 className="ph-suite-card__name">{tl.heroTitle}</h3>
              ...
              <motion.div className="ph-suite-card" {...fadeUp(0.42)} onClick={() => navigate('/suites/penthouse-suite-2-chiara')} role="button" tabIndex={0} onKeyDown={e => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); navigate('/suites/penthouse-suite-2-chiara') } }}>
                <div className="ph-suite-card__img-wrap">
