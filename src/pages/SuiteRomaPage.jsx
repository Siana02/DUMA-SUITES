...
import g1  from '../assets/suite-roma-1stbedroom-view1.jpeg'
import g2  from '../assets/suite-roma-1stbedroom-view2.jpeg'
import g3  from '../assets/suite-roma-1stbedroom-view3.jpeg'
import g4  from '../assets/suite-roma-2ndbedroom-view1.jpeg'
import g5  from '../assets/suite-roma-2ndbedroom-view2.jpeg'
import g6  from '../assets/suite-roma-2ndbedroom-view3.jpeg'
import g7  from '../assets/suite-roma-bathroom-view.jpeg'
import g8  from '../assets/suite-roma-dining-table-with-tv-view.jpeg'
import g9  from '../assets/suite-roma-kicten-view.jpeg'
import g10 from '../assets/suite-roma-kitchen-with-decor-wall-view.jpeg'
...
export default function SuiteRomaPage() {
  useEffect(() => { window.scrollTo(0, 0) }, [])
  const navigate = useNavigate()
  const t = useT()
  const pt = t.suites.roma
        ...
        <section className="ph-suites section" id="explore-suites">
          <div className="container">
            ...
            <div className="ph-suites__grid">
              ...
              <motion.div className="ph-suite-card" {...fadeUp(0.42)} onClick={() => navigate('/suites/suite-roma')} role="button" tabIndex={0} onKeyDown={e => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); navigate('/suites/suite-roma') } }}>
                <div className="ph-suite-card__img-wrap">
